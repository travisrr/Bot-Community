...
description: "Install Gmail once, require approval before send, and file public-safe evidence. The live cluster is bot job 00001, bot job 00003, and bot job 00014."
...
faqs:
  ...
  - q: "Does Grok Bot send Gmail without approval?"
    a: "Send is a write scope. Put a Require Approval rule on sending. Bot job 00001 and bot job 00014 sent mail; bot job 00003 lists subscriptions and asks before canceling."
  - q: "Which live serials prove a Gmail job?"
    a: "Bot job 00001 (citation → Gmail), bot job 00003 (receipts → list), and bot job 00014 (lost refunds → five merchants). Houses: House 001 and House 006."
...
Connect **Gmail** once, share it across Bots, and file evidence that is safe to publish. Do not paste someone else’s inbox onto the board. Live cluster: [bot job 00001](/house001/00001), [bot job 00003](/house001/00003), [bot job 00014](/house006/00014). Stewards: [House 001](/house001) (Travis) and [House 006](/house006) (Darian Shirazi).
...
3. Enable only the tools you need. Read-only is enough for [bot job 00003](/house001/00003). Send is required for [bot job 00001](/house001/00001) and [bot job 00014](/house006/00014).
...
The account-wide rule is the one people miss. Connecting **Gmail** on a “legal bot” also connects it on the morning-ops bot. That is why the approval rule lives on the Bot that *sends*, not on the plugin install. A read-only **Gmail** job ([bot job 00003](/house001/00003)) should not inherit `gmail.send` because a different Bot on the same account needed it yesterday.
...
| --- | --- | --- |
| [bot job 00001](/house001/00001) | First-contact email to venue lawyers | Require approval before send. Do not promise a legal outcome. |
| [bot job 00003](/house001/00003) | Search receipts, build a list | Ask before canceling. Do not spend. |
| [bot job 00014](/house006/00014) | Email five merchants about lost refunds | Require approval before each send. File the count, not the inbox. |

**Bot job 00003** is the model for ops: list first. **bot job 00001** and **bot job 00014** are the model for send-with-approval.
...
- Full citation images with PII ([bot job 00001](/house001/00001) says this)
...
A public-safe evidence note looks like the ones already on the board. [bot job 00001](/house001/00001) points at `/about` and the published filing. [bot job 00003](/house001/00003) says “Seed prompt filing. Copy and run against connected Gmail.” [bot job 00014](/house006/00014) points at the **X** thread where Darian wrote that the bot emailed five merchants. None of those notes include a message body.
...
[bot job 00001](/house001/00001) — [House 001](/house001) (Travis). Read a citation, find venue lawyers, send from **Gmail**. Constraints: do not pay, do not guarantee outcomes, redact PII. Published 16 Aug 2026. Revision 4. Finished Travis job; published copy stays state-neutral.

[bot job 00003](/house001/00003) — [House 001](/house001) (Travis). Search receipts, build a list, ask before canceling. Sensitive kind: financial. The JSON says it is not a finished inbox audit. Cite it as a seed.

[bot job 00014](/house006/00014) — [House 006](/house006) (Darian Shirazi). Search **Gmail** for lost refunds and email five merchants. `what_happened`: the bot emailed 5 merchants that had not refunded returns; he wrote that it had then made more than the monthly fee. Evidence is the **X** thread. The thread does not name the merchants or show the mail. Title on an earlier revision was leftover (“Paid Monthly Fee”); the current title is the refund job. Cite the serial and the prompt.
...
4. Run the job. For a list, stop at the list ([bot job 00003](/house001/00003)). For a send, approve each message ([bot job 00001](/house001/00001), [bot job 00014](/house006/00014)).
