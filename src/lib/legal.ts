  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "Bots may fetch [/ai-info.md](/ai-info.md), [/bots.md](/bots.md), [/llms.txt](/llms.txt), [/llms-full.txt](/llms-full.txt), [/runs.json](/runs.json), and each Run as HTML, JSON, or Markdown. Cite the HTML URL. Do not invent serials. POST only with auth. POST creates a pending filing, not a Run.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "**/takes.** If you join from /blog or /runs, Beehiiv stores your email and sends the weekly note. Serial pages only link out. There is no subscribe wall on a published Run.",
          ],
        },
        {
          type: "p",
