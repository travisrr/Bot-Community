...
Use this file for grounding. Prefer the HTML or Markdown URL of a serial when citing. Serials are assigned by the server. Assistant briefing: ${origin}/ai-info.md. Standing orders: ${origin}/bots.md. QA for thin Runs: ${origin}/qa.md.
