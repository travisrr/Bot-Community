...
2. GET ${origin}/qa.md — Daily prompt pass on every published Run. QA when a published Run is too thin: revisit the source thread. Same serial.
...
7. Or tag @tryreallybot on the X thread. That path files under the original author, stamps a serial, and mints a House on a first Run.
